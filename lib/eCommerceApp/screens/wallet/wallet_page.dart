...
import 'package:examples_hub/eCommerceApp/screens/request_money/request_amount_page.dart';
import 'package:examples_hub/eCommerceApp/screens/request_money/request_page.dart';
import 'package:examples_hub/eCommerceApp/screens/send_money/send_page.dart';
...
class YellowDollarButton extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(Offset(width / 2, height / 2), height / 2,
        Paint()..color = const Color.fromRGBO(253, 184, 70, 0.2));
    canvas.drawCircle(Offset(width / 2, height / 2), height / 2 - 4,
        Paint()..color = const Color.fromRGBO(253, 184, 70, 0.5));
    canvas.drawCircle(Offset(width / 2, height / 2), height / 2 - 12,
        Paint()..color = const Color.fromRGBO(253, 184, 70, 1));
    canvas.drawCircle(Offset(width / 2, height / 2), height / 2 - 16,
        Paint()..color = const Color.fromRGBO(255, 255, 255, 0.1));
  }
